...
// ==========================================
testRoute.get("/collections/all", getAllCollections);
testRoute.get("/collections/:collectionId", authMiddleware, getCollectionById); // Fetch tests for a specific collection
